...
def TAMPILKAN_BANNER():
    ...
    printf(Panel(r"""[bold red]  ____  _____ _     _ 
/  _ \/  __// \ |\/ \
| | \||  \  | | //| |
| |_/||  /_ | \// | |
\____/\____\\__/  \_/
    ...
    [underline red]Facebook Comments Home Page - Coded by Devi""", width=57, style="bold light_slate_grey"))
...
if __name__ == '__main__':
    try:
        if os.path.exists("Penyimpanan/Subscribe.json") == False:
            YOUTUBE_URL = json.loads(requests.get('https://raw.githubusercontent.com/devixaayyat').text)['Link']
